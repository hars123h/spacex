    ...
    return (
        <div className='relative bg-white'>
            ...
            <div className='text-center'>
                <img src={spacex} alt="hp_logo" className='m-auto md:w-2/6 sm:w-1/6 mt-4 mb-2' width={"70%"} />
            </div>
            <div style={{ boxShadow: "0 0.053333rem 0.533333rem 0.053333rem #dfdfdf" }} className="box mb-20   gap-2 m-auto  rounded-xl lg:w-2/5 w-[88%]  p-4 w-50% flex flex-col">
                ...
                <div className=' flex justify-between bg-white items-center mb-2 outline-none cstm_b  rounded-full px-2'>
                ...
                <div onClick={() => navigate('/login')} className='cursor-pointer text-center text-black  p-[7px] mb-2 bg-white  rounded-full border border-gray-200'>
