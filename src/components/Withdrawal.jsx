    ...
    return (
        <div className='bg-withdraw flex flex-col  sm:h-[1000px] md:h-[950px] relative'>
            ...
            <div className="part1 bg-white p-3 rounded-lg mx-3 mt-5">
                <div className='text-red-800 px-2 my-1  rounded-full border text-xs border-red-800 inline'>Tax {amountDetails.withdrawal_fee}% </div>
                ...
                <div className='flex items-center justify-start gap-4 my-1'>
                    ...
                    <div onClick={handleWithdrawalAll} className="withdraw font-normal text-red-800 text-sm cursor-pointer">Withdraw all</div>
                </div>
            </div>

            <div className="part1 bg-white p-3 rounded-lg mx-3 mt-5 flex flex-col gap-3 text-xs">
                <div className='text-red-600 font-medium'>* Withdrawal time 10:00 - 19:00</div>
                <div className='text-red-600 font-medium'>* Minimum withdrawal amount: {amountDetails.mwamount}.</div>
                <div className='text-red-600 font-medium'>* Correctly fill in the bank information IFSC code, payee name, bank card number, otherwise the withdrawal will fail.</div>
                <div className='text-red-600 font-medium'>* The actual arrival time of all withdrawals is subject to the processing time of the local bank.</div>
            </div>

            {/* [#2e9afe] */}

            <button onClick={handleLastButton} className='bg-red-800 text-white text-lg mt-5 mx-auto  mb-20 rounded-md  shadow-md block w-[95%] py-2 shadow-slate-400'>Confirm</button>
