        ...
        <div className='relative bg-white'>
            ...
            <div className='flex flex-col m-auto w-[74%] mt-11'>
                <div className=" items-center mb-3 p-2 phoneno flex  bg-[#f1f1f1] rounded-md ">
                    <img src={asset0} alt="user" className='h-5 border-r-2 pr-2 pl-1 border-solid border-gray-300' />
                ...
                <div className=" items-center p-2 passowrd flex  bg-[#f1f1f1] rounded-md ">
                    <img src={asset1} alt="user" className='h-5 border-r-2 pr-2 pl-1 border-solid border-gray-300' />
                ...
                <div className='mt-14 flex flex-col gap-6' >
                    <button onClick={handleSignIn} style={{boxShadow:"-1px 5px 15px 0 #0f1c28"}} className='bg-red-800  w-full pt-2 pb-2 text-md text-white rounded-md 
                    '>Login</button>
                ...
                {/*[#379EFE] */}
                <div className="options flex justify-between mt-2 mx-1 pt-1 text-sm">
