...
const ForgotPassword = () => {
    ...
    return (
        <div className='bg-red-800 h-screen relative'>
            ...
            <div className='text-center bg-red-800 font-sans text-white pt-2 text-lg mb-10 shadow-sm shadow-gray-50
        pb-2'> <svg xmlns="http://www.w3.org/2000/svg" onClick={() => navigate('/login')} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" 
        className="w-6 h-6 absolute left-2 cursor-pointer hover:bg-white hover:stroke-black hover:rounded-full transition rounded-full ease-in-out delay-150 duration-200">
            ...
            {/* [#d3d6fe] */}
            <div className="box mb-20 border-2 m-auto border-gray-200 bg-gray-600 rounded-3xl border-solid lg:w-3/5 w-4/5 shadow-xl shadow-gray-600 p-4 w-50% flex flex-col">
